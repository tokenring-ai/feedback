...
export const parameters = z.object({
  ...
  choices: z.array(z.string()).describe("A list of choices for the human to select from. Required if response_type is 'single' or 'multiple'.").optional(),
  response_type: z.enum(["text", "single", "multiple"]).describe("Specifies the expected type of response. Defaults to 'text' if choices are absent, and 'single' if choices are present.").optional()
});
